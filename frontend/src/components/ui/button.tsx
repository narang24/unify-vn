...
const buttonVariants = {
  default:
    "bg-[color:var(--accent)] text-[color:var(--accent-foreground)] shadow-sm hover:bg-[color:var(--accent-soft)] dark:bg-[color:var(--accent)]/85 dark:text-white dark:hover:bg-[color:var(--accent)]/75",
  outline:
